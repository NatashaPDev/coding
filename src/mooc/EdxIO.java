...
public class EdxIO implements Closeable {
    /**
     * Creates a default instance of mooc.EdxIO
     * which reads input from "input.txt"
     * and writes output to "output.txt".
     *
     * @return the new mooc.EdxIO instance.
     */
     ...
     *
     * It has an abstract method {#receive(mooc.EdxIO)} for doing the real work when the mooc.EdxIO instance is created,
     * and an implementation of public-static-void-main which creates an instance and delegates to {#receive(mooc.EdxIO)}.
     */
    public static abstract class Receiver {
        /**
         * This is an abstract method for doing the real work.
         *
         * @param io an instance of mooc.EdxIO for reading and writing.
         */
     ...
     *
     * @return this instance of {@code mooc.EdxIO} to be used with chaining calls.
     */
